...
[![macOS](https://img.shields.io/badge/macOS-12.5.1-c62eb8)](https://www.apple.com.cn/macos/monterey/)
...
此 EFI 使用`iMac19,1`机型，微星 B360M 迫击炮 (钛金版) 的绝大部分用户可通过修改使用，核显 + 独显共同硬解，默认启用全部 USB 端口，OpenCore 版本：0.8.4，最高支持 macOS Ventura 13 测试版。
