...
此 EFI 使用`iMac19,1`机型，微星 B360M 迫击炮 (钛金版) 的绝大部分用户可通过修改使用，核显 + 独显共同硬解，默认启用全部 USB 端口，OpenCore 版本：0.8.5，最高支持 macOS Ventura 13 正式版。
...
*OC 0.8.5 正式版的配置文件较上个版本无增改。支持 macOS 13 Ventura 正式版，推送后可直接更新。*
