...
[![macOS](https://img.shields.io/badge/macOS-12.5.1-c62eb8)](https://www.apple.com/macos/monterey/)
[![macOS](https://img.shields.io/badge/macOS-13%20beta-ffb84a)](https://www.apple.com/macos/macos-ventura-preview/)
...
This EFI uses `iMac19,1` SMBIOS. Most users of MSI B360M MORTAR (includes TITANIUM version) can use it through modification. The integrated graphics and discrete graphics participate in hardware decoding. By default, all USB ports are injected. OpenCore version: 0.8.4. The highest supported system is macOS Ventura 13 beta.
